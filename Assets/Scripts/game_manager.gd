...
# RECIPES
var recipes = {
	[items.BOILED_NYAA_LEAF, items.OOF_ROCK]: antidotes.DE_MEOWER,
	[items.BOILED_STAR_FLOWER, items.BOILED_DRAGON_SCALE]: antidotes.DE_NNERBONE,
	[items.NYAA_LEAF, items.BOILED_OOF_ROCK, items.STAR_FLOWER]: antidotes.WATERY_WOOFER,
	[items.DRAGON_SCALE]: antidotes.A_SACK_O_ONIONS,
	[items.BOILED_STAR_FLOWER, 
